...
export function useAuthGetUser<TData = T.AuthGetUserResponseApi>(opts: {
  ...
  return useQuery(
    useAuthGetUser.queryKey(opts.params),
    ({ signal }) => {
      return apiAuthGetUser(axiosInstance, opts.params, { signal });
    },
    options,
  );
}
 ...
 */
useAuthGetUser.queryKey = (params: T.AuthGetUserParamsInput): QueryKey => [
...
useAuthGetUser.fetch = (
  ...
  queryClient.fetchQuery(useAuthGetUser.queryKey(data.params), () =>
    apiAuthGetUser(axiosInstance, data.params),
  );
/**
...
useAuthGetUser.prefetch = (
  ...
  queryClient.prefetchQuery(useAuthGetUser.queryKey(data.params), () =>
    apiAuthGetUser(axiosInstance, data.params),
  );
/**
...
) => queryClient.invalidateQueries(useAuthGetUser.queryKey(keyInput.params));
/**
...
) => queryClient.setQueryData(useAuthGetUser.queryKey(queryKey.params), data);
...
export function useAuthLogout(
  ...
  const axiosInstance = useApi();
  return useMutation(variables => apiAuthLogout(axiosInstance), options);
}
 ...
 */
export function useAuthMe<TData = T.AuthMeResponseApi>(
  opts?:
    | {
  ...
  return useQuery(
    useAuthMe.queryKey(),
    ({ signal }) => {
      return apiAuthMe(axiosInstance, { signal });
    },
    options,
  );
}
 ...
 */
useAuthMe.fetch = (queryClient: QueryClient, axiosInstance: AxiosInstance) =>
  queryClient.fetchQuery(useAuthMe.queryKey(), () => apiAuthMe(axiosInstance));
/**
 * Prefetch useAuthMe via the queryClient
 */
useAuthMe.prefetch = (queryClient: QueryClient, axiosInstance: AxiosInstance) =>
  queryClient.prefetchQuery(useAuthMe.queryKey(), () => apiAuthMe(axiosInstance));
/**
 * Invalidate useAuthMe via the queryClient
 */
useAuthMe.invalidate = (queryClient: QueryClient, axiosInstance: AxiosInstance) =>
  queryClient.invalidateQueries(useAuthMe.queryKey());
/**
 * Set data for useAuthMe on the queryClient
 */
useAuthMe.setQueryData = (queryClient: QueryClient, data: T.AuthMeResponseApi) =>
...
export function useAuthRefreshTokens(
  ...
  const axiosInstance = useApi();
  return useMutation(variables => apiAuthRefreshTokens(axiosInstance, variables.body), options);
}
...
export function useAuthSetUserActive(
  options: UseMutationOptions<
    T.AuthSetUserActiveResponseApi,
    AppErrorResponse,
  ...
  const axiosInstance = useApi();
  return useMutation(
    variables => apiAuthSetUserActive(axiosInstance, variables.params, variables.body),
    options,
  );
}
...
export function useAuthUpdateUser(
  ...
  const axiosInstance = useApi();
  return useMutation(
    variables => apiAuthUpdateUser(axiosInstance, variables.params, variables.body),
    options,
  );
}
...
export function useAuthUserList<TData = T.AuthUserListResponseApi>(opts: {
  ...
  const options = opts?.options ?? {};
  return useQuery(
    useAuthUserList.queryKey(opts.body),
    ({ signal }) => {
      return apiAuthUserList(axiosInstance, opts.body, { signal });
    },
    options,
  );
}
 ...
 */
useAuthUserList.queryKey = (body: T.AuthUserListBodyInput): QueryKey => [...useAuthUserList.baseKey(), body];
/**
...
useAuthUserList.fetch = (
  ...
  queryClient.fetchQuery(useAuthUserList.queryKey(data.body), () =>
    apiAuthUserList(axiosInstance, data.body),
  );
/**
...
useAuthUserList.prefetch = (
  ...
  queryClient.prefetchQuery(useAuthUserList.queryKey(data.body), () =>
    apiAuthUserList(axiosInstance, data.body),
  );
/**
...
) => queryClient.invalidateQueries(useAuthUserList.queryKey(keyInput.body));
/**
...
) => queryClient.setQueryData(useAuthUserList.queryKey(queryKey.body), data);
