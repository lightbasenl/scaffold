 ...
 */
export function useAuthTotpProviderInfo<TData = T.AuthTotpProviderInfoResponseApi>(
  opts?:
    | {
  ...
  return useQuery(
    ...
    ({ signal }) => {
      return apiAuthTotpProviderInfo(axiosInstance, { signal });
    },
    options,
  );
}
 ...
 */
useAuthTotpProviderInfo.fetch = (queryClient: QueryClient, axiosInstance: AxiosInstance) =>
  queryClient.fetchQuery(useAuthTotpProviderInfo.queryKey(), () => apiAuthTotpProviderInfo(axiosInstance));
/**
 * Prefetch useAuthTotpProviderInfo via the queryClient
 */
useAuthTotpProviderInfo.prefetch = (queryClient: QueryClient, axiosInstance: AxiosInstance) =>
  queryClient.prefetchQuery(useAuthTotpProviderInfo.queryKey(), () => apiAuthTotpProviderInfo(axiosInstance));
/**
 * Invalidate useAuthTotpProviderInfo via the queryClient
 */
useAuthTotpProviderInfo.invalidate = (queryClient: QueryClient, axiosInstance: AxiosInstance) =>
  queryClient.invalidateQueries(useAuthTotpProviderInfo.queryKey());
/**
 * Set data for useAuthTotpProviderInfo on the queryClient
 */
useAuthTotpProviderInfo.setQueryData = (queryClient: QueryClient, data: T.AuthTotpProviderInfoResponseApi) =>
...
export function useAuthTotpProviderRemove(
  options: UseMutationOptions<
    T.AuthTotpProviderRemoveResponseApi,
    AppErrorResponse,
...
> {
  const axiosInstance = useApi();
  return useMutation(variables => apiAuthTotpProviderRemove(axiosInstance), options);
}
...
export function useAuthTotpProviderRemoveForUser(
  options: UseMutationOptions<
    T.AuthTotpProviderRemoveForUserResponseApi,
    AppErrorResponse,
...
> {
  const axiosInstance = useApi();
  return useMutation(variables => apiAuthTotpProviderRemoveForUser(axiosInstance, variables.params), options);
}
...
export function useAuthTotpProviderSetup(
  options: UseMutationOptions<
    T.AuthTotpProviderSetupResponseApi,
    AppErrorResponse,
...
> {
  const axiosInstance = useApi();
  return useMutation(variables => apiAuthTotpProviderSetup(axiosInstance, variables.body), options);
}
...
export function useAuthTotpProviderSetupVerify(
  options: UseMutationOptions<
    T.AuthTotpProviderSetupVerifyResponseApi,
    AppErrorResponse,
...
> {
  const axiosInstance = useApi();
  return useMutation(variables => apiAuthTotpProviderSetupVerify(axiosInstance, variables.body), options);
}
...
export function useAuthTotpProviderVerify(
  options: UseMutationOptions<
    T.AuthTotpProviderVerifyResponseApi,
    AppErrorResponse,
...
> {
  const axiosInstance = useApi();
  return useMutation(variables => apiAuthTotpProviderVerify(axiosInstance, variables.body), options);
}
