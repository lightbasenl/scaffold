...
export type AuthUserSummaryApi = {"id": string, "name"?: undefined|string, "lastLogin": string, "anonymousLogin"?: undefined|{"isAllowedToLogin": boolean, "createdAt": string, }, "digidLogin"?: undefined|{"createdAt": string, }, "keycloakLogin"?: undefined|{"email": string, "createdAt": string, }, "passwordLogin"?: undefined|{"email": BackendEmailApi, "createdAt": string, "verifiedAt"?: undefined|string, }, "totpProvider"?: undefined|{"enabledAt": string, }, "roles": ({"id": string, "identifier": string, })[], "permissions": (AuthPermissionIdentifierApi)[], "createdAt": string, "deletedAt"?: undefined|string, };
export type BackendEmailApi = string;
export type AuthPermissionIdentifierApi = "auth:user:list"|"auth:user:manage"|"auth:permission:manage"|"auth:keycloak:user:create"|"auth:totp:manage";
...
export type AuthSessionApi = {"type": AuthSessionTypeApi, "loginType": AuthLoginTypeApi, "twoStepType"?: undefined|AuthTwoStepTypeApi, "userId": string, };
...
export type AuthTwoStepTypeApi = "totpProvider";
...
export type AuthUserListBodyInput = {"search"?: undefined|{"name"?: undefined|string, }, "filters"?: undefined|{"anonymousLoginExists"?: undefined|boolean, "digidLoginExists"?: undefined|boolean, "keycloakLoginExists"?: undefined|boolean, "passwordLoginExists"?: undefined|boolean, "includeAnonymousTemporarySessions"?: undefined|boolean, "includeSoftDeletedUsers"?: undefined|boolean, }, };
...
export type AuthPasswordBasedListEmailsResponseApi = {"emails": ({"email": AuthPasswordBasedEmailApi, "isVerified": boolean, "verifiedAt"?: undefined|string, "createdAt": string, })[], };
export type AuthPasswordBasedEmailApi = BackendEmailApi;
export type AuthPasswordBasedLoginBodyInput = {"email": AuthPasswordBasedEmailInput, "password": AuthPasswordBasedPasswordInput, };
export type AuthPasswordBasedPasswordInput = BackendEmailApi;
export type AuthPasswordBasedTokenPairApi = AuthTokenPairApi;
export type AuthPasswordBasedResetPasswordBodyInput = {"resetToken": string, "password": AuthPasswordBasedPasswordInput, };
...
export type AuthPermissionPermissionListResponseApi = {"permissions": ({"id": string, "identifier": AuthPermissionIdentifierApi, })[], };
...
export type AuthPermissionRoleListResponseApi = {"roles": ({"id": string, "identifier": string, "isEditable": boolean, "permissions": (AuthPermissionIdentifierApi)[], })[], };
...
export type AuthPermissionSummaryResponseApi = {"roles": ({"id": string, "identifier": string, })[], "permissions": (AuthPermissionIdentifierApi)[], };
